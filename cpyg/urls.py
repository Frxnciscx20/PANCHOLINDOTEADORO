...
from .views import index, feriados, formContacto, formReg, fotos, productos, qsomos, form_mod_cliente, form_mod_producto, form_crear_cliente, form_crear_producto, mostrar, mostrar2,  form_del_cliente, form_del_producto 
